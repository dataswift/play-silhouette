...
import com.mohiva.play.silhouette.api.{ DynamicEnvironment, Identity, LoginInfo }
...
/**
  ...
  */
trait IdentityService[T <: Identity, D <: DynamicEnvironment] {
  ...
  /**
    ...
    */
  def retrieve(loginInfo: LoginInfo)(implicit dyn: D): Future[Option[T]]
}
