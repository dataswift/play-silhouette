...
object Authorization {
  ...
  /**
    ...
    */
  implicit final class RichAuthorization[I <: Identity, A <: Authenticator, D <: DynamicEnvironment](
      self: Authorization[I, A, D]
    )(implicit
      ec: ExecutionContext) {
    ...
    /**
      ...
      */
    def unary_! : Authorization[I, A, D] =
      new Authorization[I, A, D] {
        def isAuthorized[B](
            identity: I,
            authenticator: A,
            dynamicEnvironment: D
    ...
    /**
      ...
      */
    def &&(authorization: Authorization[I, A, D]): Authorization[I, A, D] =
      new Authorization[I, A, D] {
        def isAuthorized[B](
            identity: I,
            authenticator: A,
