...
/**
  ...
  */
case class SignUpEvent[I <: Identity](
    identity: I,
    request: RequestHeader)
    extends SilhouetteEvent
...
/**
  ...
  * @tparam I The type of the identity.
  */
case class LoginEvent[I <: Identity](
    identity: I,
    request: RequestHeader)
    extends SilhouetteEvent
...
/**
  ...
  * @tparam I The type of the identity.
  */
case class LogoutEvent[I <: Identity](
    identity: I,
    request: RequestHeader)
    extends SilhouetteEvent
...
/**
  ...
  * @tparam I The type of the identity.
  */
case class AuthenticatedEvent[I <: Identity](
    identity: I,
    request: RequestHeader)
    extends SilhouetteEvent
...
/**
  ...
  * @tparam I The type of the identity.
  */
case class NotAuthorizedEvent[I <: Identity](
    identity: I,
    request: RequestHeader)
    extends SilhouetteEvent
...
class EventBus extends ActorEventBus with SubchannelClassification {
  ...
  /**
    ...
    */
  implicit override protected val subclassification = new Subclassification[Classifier] {
    def isEqual(
        x: Classifier,
