...
class BearerTokenAuthenticatorService(
    ...
    extends AuthenticatorService[BearerTokenAuthenticator, DynamicEnvironment]
    with Logger {
  ...
  override def retrieve[B](
      ...
      dyn: DynamicEnvironment): Future[Option[BearerTokenAuthenticator]] =
    Future
