...
/**
  ...
  */
class DelegableAuthInfoRepository[D <: DynamicEnvironment](
    daos: DelegableAuthInfoDAO[_, D]*
  )(implicit ec: ExecutionContext)
    extends AuthInfoRepository[D] {
  ...
  /**
    ...
    */
  override def remove[T <: AuthInfo](
      loginInfo: LoginInfo
    )(implicit tag: ClassTag[T],
      dyn: D): Future[Unit] =
    daos.find(_.classTag == tag) match {
