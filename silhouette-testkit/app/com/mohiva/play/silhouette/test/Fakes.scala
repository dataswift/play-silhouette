...
/**
  ...
  */
class FakeIdentityService[I <: Identity, D <: DynamicEnvironment](identities: (LoginInfo, I)*)
    extends IdentityService[I, D] {
...
/**
  ...
  */
case class FakeSessionAuthenticatorService()
    extends SessionAuthenticatorService(SessionAuthenticatorSettings(),
...
/**
  ...
  */
case class FakeCookieAuthenticatorService[D <: DynamicEnvironment]()
    extends CookieAuthenticatorService[D](new CookieAuthenticatorSettings(),
                                          None,
                                          new Signer {
...
/**
  ...
  */
case class FakeBearerTokenAuthenticatorService()
    extends BearerTokenAuthenticatorService(BearerTokenAuthenticatorSettings(),
...
/**
  ...
  */
case class FakeJWTAuthenticatorService()
    extends JWTAuthenticatorService(JWTAuthenticatorSettings(sharedSecret = UUID.randomUUID().toString),
                                    None,
                                    new Base64AuthenticatorEncoder,
                                    new SecureRandomIDGenerator(),
                                    Clock()
...
/**
  ...
  */
case class FakeJWTRS256AuthenticatorService()
    extends JWTRS256AuthenticatorService(new JWTRS256AuthenticatorSettings(),
                                         None,
                                         new Base64AuthenticatorEncoder,
                                         new SecureRandomIDGenerator(),
                                         Clock()
...
object FakeAuthenticator {
  ...
  def apply[E <: Env](
      loginInfo: LoginInfo
    )(implicit env: Environment[E],
      requestHeader: RequestHeader): E#A =
...
class FakeDynamicEnvironmentProviderService[D <: DynamicEnvironment](environment: D)
    extends DynamicEnvironmentProviderService[D] {
...
case class FakeEnvironment[E <: Env](
  ...
  /**
    ...
    */
  val dynamicEnvironmentProviderService: DynamicEnvironmentProviderService[E#D] =
    new FakeDynamicEnvironmentProviderService[E#D](dynamicEnvironment)
